"""
Django settings for cxdsgd_6 project.
...
WSGI_APPLICATION = 'cxdsgd_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cxdsgd_6 API",
    "DESCRIPTION": "API documentation for cxdsgd_6 App",
    "VERSION": "v1",
}
